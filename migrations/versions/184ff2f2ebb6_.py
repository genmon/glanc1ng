...
Revision ID: 184ff2f2ebb6
Revises: 3d94a946ae65
Create Date: 2013-12-30 10:26:49.166140

"""

# revision identifiers, used by Alembic.
revision = '184ff2f2ebb6'
down_revision = '3d94a946ae65'
...
def upgrade():
    ...
    op.create_index('ix_connections_provider_user_id', 'connections', ['provider_user_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ix_connections_provider_user_id', 'connections')
    ### end Alembic commands ###
